...
export default function ContactForm() {
    ...
    return (
        <div className="relative animate-appearFromBottom2 pt-5 pb-5">
            <AnimatePresence>
                {!sent ? (
                    <motion.div
                        key="form"
                    ...
                    >
                        ...
                        {isLoading && (
                            <div className="absolute bg-gray-800 opacity-75 rounded-xl w-full h-full top-0 z-20 flex items-center justify-center">
                                <svg
                                    aria-hidden="true"
